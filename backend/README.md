...
## Project Structure
    ...
    ├── readycoordinator_38040  # Django project configurations
...
1. Clone this repo and `cd readycoordinator_38040`
...
2. Clone this repo and `cd readycoordinator_38040`
